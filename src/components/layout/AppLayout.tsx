  ...
  return (
    <div className="min-h-screen bg-surface-deep flex flex-col transition-colors duration-200">
      ...
      <header className="bg-surface border-b border-gray-200 dark:border-gray-800/50 sticky top-0 z-50 transition-colors duration-200">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="hidden lg:block relative">
                ...
                <input 
                  type="text" 
                  placeholder="Search..." 
                  className="pl-9 pr-4 py-1.5 bg-surface-input dark:bg-surface-input border border-gray-200 dark:border-gray-800/50 rounded-full focus:ring-2 focus:ring-brand text-sm w-48 xl:w-64 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-secondary transition-colors duration-200 focus:outline-none"
                />
              </div>
              ...
              <button 
                onClick={toggleTheme}
                className="p-2 rounded-full text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200 flex-shrink-0"
              >
              ...
              <div className="relative" ref={notificationsRef}>
                <button 
                  ...
                  className="relative p-2 rounded-full text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200 flex-shrink-0 focus:outline-none"
                >
                  <Bell className="h-5 w-5" />
                  <span className="absolute top-1.5 right-1.5 h-2 w-2 bg-red-500 rounded-full border-2 border-white dark:border-[#111827]"></span>
                </button>
              ...
              <div className="relative ml-1 sm:ml-2" ref={profileRef}>
                <button 
                  ...
                  className="flex items-center gap-2 p-1 pr-2 rounded-full border border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2 dark:focus:ring-offset-[#111827]"
                >
                ...
                {isProfileOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-surface rounded-2xl shadow-lg border border-gray-100 dark:border-gray-800/50 py-2 z-50 origin-top-right animate-in fade-in slide-in-from-top-2 duration-200">
        ...
        <div className="hidden sm:block border-t border-gray-100 dark:border-gray-800/50 bg-surface-input dark:bg-surface-input">
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 whitespace-nowrap border ${
                      isActive
                        ? 'bg-white dark:bg-surface-input text-brand dark:text-brand-light border-gray-200 dark:border-gray-700 shadow-sm'
                  ...
                  >
                    <item.icon className={`mr-2 h-4 w-4 flex-shrink-0 ${isActive ? 'text-brand dark:text-brand-light' : 'text-gray-400 dark:text-gray-500'}`} />
                    {item.name}
                  </Link>
                );
              })}
      ...
      <div className="sm:hidden fixed bottom-0 left-0 right-0 bg-surface border-t border-gray-200 dark:border-gray-800/50 z-50 pb-safe">
